...
namespace SendTest
{
    public class HowToUse : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            gamedata = "<data><target>happy</target><trial num=1><face>happy</face><lr>left</lr><correct>yes</correct><reactiontime>1000</reactiontime></trial><trial num=2><face>anger</face><lr>right</lr><correct>no</correct><reactiontime>2300</reactiontime></trial></data>";
        }
